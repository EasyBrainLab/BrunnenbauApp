...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="bg-primary-500 text-white shadow-lg">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3 hover:opacity-90 transition-opacity">
            <div className="w-10 h-10 bg-sand-400 rounded-full flex items-center justify-center">
            ...
            <div>
              <h1 className="text-xl font-heading font-bold">Brunnenbau</h1>
              <p className="text-xs text-blue-200">Ihr Anfrageportal</p>
            </div>
          </Link>
      ...
      {/* Footer */}
      <footer className="bg-primary-700 text-blue-200 text-sm">
        <div className="max-w-6xl mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p>&copy; {new Date().getFullYear()} Brunnenbau GmbH. Alle Rechte vorbehalten.</p>
