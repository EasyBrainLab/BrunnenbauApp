...
export default function Step2Usage({ data, onChange, onFileChange }) {
  ...
  return (
    <div>
      <h2 className="text-2xl font-heading font-semibold text-primary-500 mb-2">Verwendungszweck des Brunnens</h2>
      ...
      {/* Plausibilitaetswarnungen fuer Nutzungszwecke */}
      {(() => {
        const usageWarnings = runPlausibilityChecks(data, 'usage');
        if (!usageWarnings || usageWarnings.length === 0) return null;
        return (
          <div className="space-y-2 mb-6">
