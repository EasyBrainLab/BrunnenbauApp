    ...
    <div>
      ...
      <div className="space-y-4 mb-8">
        ...
        <div className="flex items-center gap-2 p-3 bg-blue-50 border border-blue-200 rounded-lg text-sm">
          ...
          {/* Ohne Nennung/Verlinkung eines konkreten Anbieters — siehe Step1Contact. */}
          <span className="text-gray-700">
            Laden Sie gern ein Luftbild oder einen Lageplan Ihres Grundstücks hoch. Ein Screenshot
            aus einem Online-Kartendienst (Satellitenansicht) oder eine einfache Handskizze
            genügt uns völlig.
          </span>
        </div>
