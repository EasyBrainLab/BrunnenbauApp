...
export const DIAGNOSES = [
  ...
  // ===== Wasserqualität =====
  {
    ...
    solution: 'Eine Enteisenungsanlage (Belüftung + Filter) schafft Abhilfe. Für Trinkwassernutzung gelten Grenzwerte (Eisen 0,2 mg/l).',
    confirmTest: 'st_belueftung',
    severity: 'mittel',
    diySolvable: false,
    cta: 'beratung',
  ...
  },
  {
    ...
    solution: 'Entmanganung über eine Aufbereitungsanlage (Belüftung + Filter). Für Trinkwasser gilt der Grenzwert 0,05 mg/l.',
    severity: 'mittel',
    diySolvable: false,
    cta: 'beratung',
